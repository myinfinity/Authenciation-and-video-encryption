 ...
 */
uint16_t ETH_ReadPHYRegister(uint16_t PHYAddress, uint16_t PHYReg)//PHYAddress 0x01  1
{
    uint32_t      tmpreg = 0;
 ...
 */
uint32_t ETH_WritePHYRegister(uint16_t PHYAddress, uint16_t PHYReg, uint16_t PHYValue)//PHYAddress 0x01
{
    uint32_t      tmpreg = 0;
    __IO uint32_t timeout = 0;
