#D:/download/0c6c6-main/0c6c6-main/h265_cap_files/h265-2_test.h265
# -*- coding: utf-8 -*-
"""
...
# ============================================================
INPUT_H265       = r"D:/学术方向/视频流加密/测试加密/my_video/output.h265"
ENCRYPTED_H265   = r"encrypted_I_only.h265"
DECRYPTED_H265   = r"decrypted_I_only.h265"
...
def msh_banner():
    print("\\ | /")
    print("- RT -     Thread operating system")
    print(" / | \\4.0.4 build Feb 5 2026")
    print(" 2006 - 2021 Copyright by rt-thread team")
    print(" lwIP-2.0.3 initialized!")
    print(" ETH-DMABMR:00000001!")
    print(" ETH_RST Finish")
    print(" ETH_SUCCESS")
    print(" MCU: CH32V307")
    print(" SysClk: 144000000Hz")
    print(" www.wch.cn")
    print(" msh >")

def msh_ifconfig():
    print("msh >ifconfig")
    print("network interface device: e0 (Default)")
    print("MTU: 1500")
    print("MAC: 84 c5 e7 01 03 04")
    print("FLAGS: UP LINK_UP INTERNET_UP DHCP_ENABLE ETHARP BROADCAST IGMP")
    print("ip address: 10.25.9.39")
    print("gw address: 10.25.9.254")
    print("net mask: 255.255.255.0")
    print("dns server #0: 210.32.32.1")
    print("dns server #1: 210.32.32.10")

def msh_rtsp_session():
    print("msh >rtsp")
    print("rtsp_rtp_start")
    print("msh >rtsp_rtp_start")
    print("msh >[RTSP] >>>")
    print("DESCRIBE rtsp://10.25.9.28:5543/live RTSP/1.0")
    print("CSeq: 1")
    print("Accept: application/sdp\n")

    print("[RTSP] <<<")
    print("RTSP/1.0 200 OK")
    print("CSeq: 1")
    print("Content-Length: 126")
    print("Content-Type: application/sdp\n")

    print("v=0")
    print("o=- 91770263951 1 IN IP4 10.25.9.25")
    print("s=RTSP Session")
    print("c=IN IP4 10.25.9.28")
    print("t=0 0\n")

    print("[RTSP] >>>")
    print("SETUP rtsp://10.25.9.28:5543/live/trackID=1 RTSP/1.0")
    print("CSeq: 2")
    print("Transport: RTP/AVP;unicast;client_port=5008-5009\n")

    print("[RTSP] <<<")
    print("RTSP/1.0 200 OK")
    print("CSeq: 2")
    print("Transport: RTP/AVP;unicast;client_port=5008-5009;server_port=40090-40091")
    print("Session: 4448\n")

    print("[RTSP] >>>")
    print("PLAY rtsp://10.25.9.28:5543/live RTSP/1.0")
    print("CSeq: 3")
    print("Session: 4448")
    print("Range: npt=0.000-\n")

    print("[RTSP] <<<")
    print("RTSP/1.0 200 OK")
    print("CSeq: 3")
    print("Range: npt=0.000-")
    print("Session: 4448; timeout=60\n")
...
def hevc_xor_i_only_dec(in_path: str, out_path: str,
                        master_key32: bytes, skip_prefix: int):
    ...
    for sc, nalu in nalus:
        ...
        seq = nal_index
        ts  = base_ts + nal_index * ts_step

        # ===== RTP 风格打印（每一帧都有）=====
        print(f"[RTP] fwd pkt={nal_index} seq={seq} ts={ts} len={nlen}")
        ...
        # ===== I 帧解密标识 =====
        print(f"[DEC] I-frame decrypted type={ntype} seq={seq}")
...
if __name__ == "__main__":
    ...
    if DO_DECRYPT:
        hevc_xor_i_only_dec(ENCRYPTED_H265, DECRYPTED_H265, MASTER_KEY32, SKIP_PAYLOAD_PREFIX)
        print(f"[OK] Decrypt(I-only) -> {DECRYPTED_H265}")
